...
/** Centered aircraft detail card (drawn last, over radar + footer). */
constexpr int kDetailCardX = 22;
constexpr int kDetailCardY = 48;
constexpr int kDetailCardW = 196;
constexpr int kDetailCardH = 128;
...
/** Selected aircraft / detail-card accent (green). */
constexpr uint8_t kSelectedR = 40;
constexpr uint8_t kSelectedG = 220;
constexpr uint8_t kSelectedB = 90;
...
extern uint16_t kColorSelected;
